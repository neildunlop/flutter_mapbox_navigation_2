...
class PluginUtilities {
    companion object {
        ...
        fun sendEvent(event: MapBoxEvents, data: String = "") {
            val jsonString =
                if (MapBoxEvents.MILESTONE_EVENT == event || event == MapBoxEvents.USER_OFF_ROUTE || event == MapBoxEvents.ROUTE_BUILT || event == MapBoxEvents.ON_MAP_TAP || event == MapBoxEvents.MARKER_TAP_FULLSCREEN || event == MapBoxEvents.MAP_TAP_FULLSCREEN) "{" +
