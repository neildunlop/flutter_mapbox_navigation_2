...
class TripProgressManager {
     ...
     */
    fun setWaypointsFromMarkers(waypointList: List<Waypoint>, markers: List<com.neiladunlop.fluttermapboxnavigation2.models.StaticMarker>, isInitialSetup: Boolean = false) {
